...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|titul(?![a-z])|kapitola|kapitoly|ver[šs]e|kapitol|kap|srv|ff|-|a|[a-e](?!\w)|$)+)/gi; // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
  ...
  bcv_parser.prototype.regexps.match_end_split = /\d\W*titul|\d\W*ff(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[a-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi; //ff09 is a full-width closing parenthesis
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|[1I]\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|[1I][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|G(?:enesis|en|n)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:II|2)\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:II|2)[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|Ex(?:odus|od)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Bel"],
        apocrypha: true,
      ...
      {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:T[rř]et[i\xED][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:III|3)\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:III|3)[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|L(?:eviti(?:cusi|kus)|ev(?:iticus)?|v)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:[CČ]tvrt[a\xE1][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:IV|4)\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|(?:IV|4)[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|N(?:umeri|um?|m)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Kniha[\\s\\xa0]*S[i\\xED]rachovcova|Ecclesiasticus|S[i\\xED]rachovec|S[i\\xED]r))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:oudrost(?:[\\s\\xa0]*[SŠ]alomounova)?|dr)|Kniha[\\s\\xa0]*(?:moudrost[i\\xED]|Moudrosti)|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Pl(?:[a\\xE1][cč][\\s\\xa0]*Jerem[ij][a\\xE1][sš][uů]v)?|Kniha[\\s\\xa0]*n[a\\xE1][rř]k[uů]|Lam)|(?:Pl[a\\xE1][cč]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Jeremj[a\\xE1][sš][uů]v|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Zj(?:even(?:i(?:[\\s\\xa0]*(?:svat[e\\xE9]ho[\\s\\xa0]*Jana|Janovo))?|\\xED(?:[\\s\\xa0]*Janovo)?))?|Kniha[\\s\\xa0]*Zjeven[i\\xED]|Apokalypsa|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Modlitbu[\\s\\xa0]*Manasse|PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:P[a\xE1]t[a\xE1][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|[5V]\.[\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|[5V][\s\xa0]*(?:kniha[\s\xa0]*Moj[zž][i\xED][sš]|Moj[zž][i\xED][sš])ova|D(?:euteronomium|eut|t)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:o(?:z(?:ue)?|sh)|z)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:S(?:oudc[uů]|dc?)|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:R(?:uth?|\\xFA?t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*Ezdr[a\xE1][sš]|[1I]\.[\s\xa0]*Ezdr[a\xE1][sš]|[1I][\s\xa0]*Ezdr[a\xE1][sš]|1Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*Ezdr[a\xE1][sš]|(?:II|2)\.[\s\xa0]*Ezdr[a\xE1][sš]|(?:II|2)[\s\xa0]*Ezdr[a\xE1][sš]|2Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Isa"],
      ...
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|(?:II|2)\.[\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|(?:II|2)[\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|2Sam))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|[1I]\.[\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|[1I][\s\xa0]*(?:kniha[\s\xa0]*Samuelova|S(?:amuelova|am(?:uel)?)?)|1Sam))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|(?:II|2)\.[\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|(?:II|2)[\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|2Kgs))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|[1I]\.[\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|[1I][\s\xa0]*(?:kniha[\s\xa0]*kr[a\xE1]lovsk[a\xE1]|Kr(?:[a\xE1]lovsk[a\xE1]|[a\xE1]l)?)|1Kgs))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|(?:II|2)\.[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|(?:II|2)[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|2Chr))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|[1I]\.[\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|[1I][\s\xa0]*(?:Pa(?:ralipomenon)?|kniha[\s\xa0]*kronik|Letopis[uů]|Kronik|Kron)|1Chr))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
      ...
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Neh(?:em[ij][a\\xE1][sš])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ester[\\s\\xa0]*(?:\\(řeck\\xE9[\\s\\xa0]*(?:dodatky|č\\xE1sti)\\)|[rř]eck[e\\xE9][\\s\\xa0]*(?:dodatky|[cč][a\\xE1]sti))|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Esth"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Kniha[\\s\\xa0]*[zž]alm[uů]|[ZŽ](?:almy|l)|[ZŽ](?:alm)?|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:P(?:ř(?:[i\\xED]s(?:lov[i\\xED][\\s\\xa0]*[SŠ]alomounova)?)?|r(?:[i\\xED]s(?:lov[i\\xED][\\s\\xa0]*[SŠ]alomounova)?|ov)?))|(?:P[rř][i\\xED]slov[i\\xED]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:K(?:ohelet|az(?:atel)?)|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:P[i\\xED]se[nň][\\s\\xa0]*ml[a\\xE1]denc[uů][\\s\\xa0]*v[\\s\\xa0]*ho[rř][i\\xED]c[i\\xED][\\s\\xa0]*peci|T[rř]i[\\s\\xa0]*mu[zž]i[\\s\\xa0]*v[\\s\\xa0]*rozp[a\\xE1]len[e\\xE9][\\s\\xa0]*peci|SgThree))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:P[i\\xED]s(?:e[nň][\\s\\xa0]*(?:[SŠ]alamounova|p[i\\xED]sn[i\\xED]))?|Song)|(?:P[i\\xED]se[nň]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:er(?:em[ij][a\\xE1][sš])?|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
      ...
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Da(?:n(?:iel)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Oz(?:e[a\\xE1][sš])?|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:(?:\\xF3e)?l|o(?:el)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:\\xC1mos|Am(?:os)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Obad(?:j[a\\xE1][sš]|j[a\\xE1])?|Abd(?:i(?:j[a\\xE1][sš]|[a\\xE1][sš]))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
      ...
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mi(?:c(?:h(?:[ae][a\\xE1][sš])?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
      ...
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ab(?:aku)?k|Hab))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:S(?:of(?:on[ij][a\\xE1][sš])?|f)|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ag(?:geus|eus)?|Hag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Z(?:a(?:ch(?:ar[ij][a\\xE1][sš])?)?|ech)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
      ...
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Evangelium[\\s\\xa0]*podle[\\s\\xa0]*Matou[sš]e|M(?:at(?:ou[sš]ovo[\\s\\xa0]*evangelium|t)|at(?:ou[sš])?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Evangelium[\\s\\xa0]*podle[\\s\\xa0]*Marka|M(?:ar(?:kovo[\\s\\xa0]*evangelium|ek)|ark|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Evangelium[\\s\\xa0]*podle[\\s\\xa0]*Luk[a\\xE1][sš]e|L(?:uk(?:[a\\xE1][sš]ovo[\\s\\xa0]*evangelium|e)|uk[a\\xE1][sš]|k)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1John)|(?:Prvn[i\xED][\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|[1I]\.[\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|[1I][\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2John)|(?:Druh[ay\xE1\xFD][\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|(?:II|2)\.[\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|(?:II|2)[\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3John)|(?:T[rř]et[i\xED][\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|(?:III|3)\.[\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)|(?:III|3)[\s\xa0]*(?:list[\s\xa0]*Jan[uů]v|J(?:anova|an[uů]v|an)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Evangelium[\\s\\xa0]*podle[\\s\\xa0]*Jana|J(?:anovo[\\s\\xa0]*evangelium|ohn|an)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Sk(?:utky(?:[\\s\\xa0]*apo[sš]tol(?:sk[e\\xE9]|[u\\xFCů]))?)?|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*[RŘ][i\\xED]man[uů]m|(?:Ř[i\\xED]|R[io\\xED])m|[RŘ])|(?:[RŘ][i\\xED]man[uů]m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD](?:[\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m)?)|K)|(?:II|2)\.(?:[\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m)?)|K)|II[\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m)?)|2[\s\xa0]*list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|2[\s\xa0]*Korintsk[y\xFD]m|2(?:[\s\xa0]*K(?:or)?|K)|2[CK]or|IIK))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED](?:[\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m|or)?)|K)|[1I]\.(?:[\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m|or)?)|K)|[1I][\s\xa0]*(?:list[\s\xa0]*Korin(?:tsk[y\xFD]|sk[y\xFD])m|K(?:orintsk[y\xFD]m|or)?)|1(?:Cor|K)|IK))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Galatsk[y\\xFD]m|Ga(?:latsk[y\\xFD]m|l)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Ef(?:\\xE9zsk[y\\xFD]|ez(?:sk[y\\xFD]|an[uů]))m|E(?:fez?sk[y\\xFD]m|ph|f)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Filipsk[y\\xFD]m|Filipensk[y\\xFD]m|Filipsk[y\\xFD]m|Phil|Fl?p))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Kolos(?:an[uů]|k[y\\xFD])m|Kolos(?:sens|ens)?k[y\\xFD]m|Kolosan[uů]m|Kol?|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|(?:II|2)\.[\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|(?:II|2)[\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|2Thess))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|[1I]\.[\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|[1I][\s\xa0]*(?:list[\s\xa0]*(?:Tesalonick[y\xFD]|Solu[nň]sk[y\xFD])m|(?:Tessalonicen|Solu[nň])sk[y\xFD]m|Tesalonick[y\xFD]m|Sol|Te)|1Thess))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|etej)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|(?:II|2)\.[\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|etej)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|(?:II|2)[\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|etej)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|2Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|ete)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|[1I]\.[\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|ete)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|[1I][\s\xa0]*(?:list[\s\xa0]*Tim(?:otej?|ete)ovi|T(?:imotejovi|imoteovi|imoteus|im|m))|1Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Titovi|T(?:itovi|itus|it|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Filemonovi|Filemonovi|Filemon|(?:Phl|Fl?)m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:Hebrej[uů]|[ZŽ]id[uů])m|Hebrej[uů]m|[ZŽ]id[uů]m|[ZŽ]id|Heb|[ZŽ]d))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Jakub[uů]v|J(?:akub[uů]v|ak(?:ub)?|as|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2Pet)|(?:Druh[ay\xE1\xFD][\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)|(?:II|2)\.[\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)|(?:II|2)[\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1Pet)|(?:Prvn[i\xED][\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)|[1I]\.[\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)|[1I][\s\xa0]*(?:list[\s\xa0]*Petr[uů]v|P(?:etrova|etr[uů]v|etr|t)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Jud[uů]v|J(?:ud(?:ova|[ae])|ud[uů]v|u|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:T(?:\\xF3bi(?:j[a\\xE1][sš]|t)|ob(?:i(?:j[a\\xE1][sš]|[a\\xE1][sš]|t))?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:[u\\xFA]d(?:it)?|dt)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Kniha[\\s\\xa0]*B[a\\xE1]ru(?:ch|k)ova|B(?:[a\\xE1]ru(?:ch|k)|[a\\xE1]r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Zuz(?:ana)?|Sus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druh[ay\xE1\xFD][\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:II|2)\.[\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:II|2)[\s\xa0]*Mak(?:abejsk[a\xE1])?|2Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:T[rř]et[i\xED][\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:III|3)\.[\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:III|3)[\s\xa0]*Mak(?:abejsk[a\xE1])?|3Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:[CČ]tvrt[a\xE1][\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:IV|4)\.[\s\xa0]*Mak(?:abejsk[a\xE1])?|(?:IV|4)[\s\xa0]*Mak(?:abejsk[a\xE1])?|4Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prvn[i\xED][\s\xa0]*Mak(?:abejsk[a\xE1])?|[1I]\.[\s\xa0]*Mak(?:abejsk[a\xE1])?|[1I][\s\xa0]*Mak(?:abejsk[a\xE1])?|1Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
